memeu = read.csv("memlen.csv");
memna = read.csv("memlfr.csv");
memas = read.csv("memles.csv");
memaf = read.csv("memlde.csv");
memoc = read.csv("memlpt.csv");
memsa = read.csv("memloth.csv");
...
legend("topleft",col=c("red","blue","green","black","cyan","yellow"),lty=1,lwd=6,legend=c("English","French","Spanish","German","Portuguese","Other"))
dev.off()
